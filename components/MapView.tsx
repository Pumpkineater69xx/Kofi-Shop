      ...
      const icon = L.divIcon({
        ...
        html: `
          <div class="relative flex items-center justify-center ${isSelected ? 'active-marker' : ''} ${isFound ? 'opacity-60' : ''}">
            <div class="absolute w-10 h-10 bg-white rounded-full shadow-lg border-2 flex items-center justify-center transition-all" style="border-color: ${colorHex}">
