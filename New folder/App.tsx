...
import { DEFAULT_CENTER, MAP_BOUNDS } from './constants.tsx';
    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        (pos) => {
          ...
          // Only snap to user location if it's within our new bounds (Europe/Asia)
          if (lat >= MAP_BOUNDS[0][0] && lat <= MAP_BOUNDS[1][0] && 
            ...
            console.log("User location outside specified region, staying in Bulgaria.");
          }
        },
